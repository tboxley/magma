...
Router.prototype.handleRead = function (resource) {
  var amqpConnection = this.amqpConnection;
  var getExchange = this.getExchange.bind(this);
  var onReply = this.onReply.bind(this);
  var exchange = resource + '.read';
...
Router.prototype.handleUpdate = function (resource) {
  var amqpConnection = this.amqpConnection;
  var getExchange = this.getExchange.bind(this);
  var onReply = this.onReply.bind(this);
  var exchange = resource + '.update';
...
Router.prototype.handleDelete = function (resource) {
  var amqpConnection = this.amqpConnection;
  var getExchange = this.getExchange.bind(this);
  var onReply = this.onReply.bind(this);
  var exchange = resource + '.delete';
